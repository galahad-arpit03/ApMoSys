            ...
            <div className="max-w-[1600px] mx-auto px-6 sm:px-8 lg:px-16 relative z-10 w-full">
              <div className="max-w-3xl">
                ...
                >
                  ...
                  >
                    <EditableText
                      path="awards.hero.subheading"
                      fallback="Celebrating industry accolades, global security certifications, and benchmark milestones in quality engineering, cloud automation, and enterprise trust."
                      as="span"
                      multiline
                    />
                  </motion.p>
                  ...
                  <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-4">
                    ...
                    >
                      <EditableText path="awards.hero.ctaPrimary" fallback="Explore Industry Awards" as="span" />
                      <svg
