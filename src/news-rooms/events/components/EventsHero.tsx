            ...
            <div className="max-w-[1600px] mx-auto px-6 sm:px-8 lg:px-16 relative z-10 w-full">
              <div className="max-w-3xl">
                ...
                >
                  ...
                  >
                    <EditableText
                      path="events.hero.subheading"
                      fallback="Join ApMoSys executives, technology architects, and industry experts for virtual summits, technical workshops, developer hackathons, and executive roundtables."
                      as="span"
                      multiline
                    />
                  </motion.p>
                  ...
                  <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-4">
                    ...
                    >
                      <EditableText path="events.hero.ctaPrimary" fallback="Explore Upcoming Events" as="span" />
                      <svg
                    ...
                    >
                      <EditableText path="events.hero.ctaSecondary" fallback="View Event Roadmap" as="span" />
                    </a>
                  </motion.div>
                </motion.div>
              </div>
