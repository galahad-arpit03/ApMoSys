...
const metrics = [
  ...
  { id: 2, end: 500, suffix: "+", label: "Enterprise Projects" },
  { id: 3, end: 200, suffix: "+", label: "Engineering Experts" },
  { id: 4, end: 40, suffix: "+", label: "Countries Served" },
];
...
export default function StatsSection() {
  return (
    <section className="py-6 lg:py-8 bg-[#0F172A] relative overflow-hidden border-y border-[#222]">
