...
export default function Consultation() {
  return (
    <SectionThemeWrapper sectionId="blogs_consultation" defaultTheme="light">
      {(theme) => {
        const isDark = theme === "dark";
        return (
          <section className={`py-24 pb-32 transition-colors duration-300 ${
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  ...
                  <motion.a
                    ...
                    whileTap={{ scale: 0.96 }}
                    className={`w-full sm:w-auto inline-flex justify-center items-center font-bold px-8 py-3.5 rounded-md text-sm tracking-wide transition-colors ${
                      isDark ? "bg-[#1F1F1F] border border-[#3A3A3A] hover:border-[#FAFAFA] text-[#FFFFFF]" : "bg-[#FFFFFF] border border-[#C8C8C8] hover:border-[#121212] text-[#121212]"
                    }`}
                  >
                    Contact Engineering
                  </motion.a>
