...
const navItems = [
  ...
  { label: "Leadership", href: "/administrator/leadership", icon: <Users className="w-4 h-4" /> },
  { label: "Our Team", href: "/administrator/team", icon: <Users className="w-4 h-4" /> },
  { label: "Community", href: "/administrator/community", icon: <Users className="w-4 h-4" /> },
