...
export default function HeroSection() {
  ...
  return (
    <SectionThemeWrapper sectionId="services_ai_hero" defaultTheme="dark">
      {(theme) => {
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
              <div className="max-w-3xl">
                ...
                >
                  ...
                  >
                    <EditableText
                      path="services.aiEngineering.hero.heading1"
                      fallback="Intelligent AI"
                      as="span"
                    />{' '}
                    <EditableText
                      path="services.aiEngineering.hero.heading2"
                      fallback="Engineering Solutions"
                      as="span"
                  ...
                  >
                    <EditableText
                      path="services.aiEngineering.hero.subheading"
                      fallback="Design and deploy enterprise-grade AI systems that automate complex workflows, uncover deep insights, and drive transformative business outcomes — from predictive analytics to generative AI."
                      as="span"
                      multiline
                    />
                  </motion.p>
                  ...
                  <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-4">
                    ...
                    >
                      <EditableText path="services.aiEngineering.hero.ctaPrimary" fallback="Explore Our AI Solutions" as="span" />
                      <svg
                    ...
                    >
                      <EditableText path="services.aiEngineering.hero.ctaSecondary" fallback="Talk to an Expert" as="span" />
                    </a>
                  </motion.div>
                </motion.div>
              </div>
