              ...
              <div className="lg:grid lg:grid-cols-12 lg:gap-8 items-center">
                ...
                >
                  ...
                  <motion.h1 variants={fadeUp} className="mb-6 leading-none">
                    <EditableText
                      path="services.hero.heading"
                      fallback="End-to-End Engineering Services for Enterprise Scale"
                      as="span"
                  ...
                  >
                    ...
                    >
                      <EditableText
                        path="services.hero.ctaSecondary"
                        fallback="Talk to an Expert"
                        as="span"
                      />
                    </a>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="relative z-10 flex flex-col items-center gap-3">
                      <div className="flex gap-4">
                        <div
                          className={`w-16 h-16 rounded-full border-4 border-t-primary-red animate-spin ${
                            isDark ? "border-[#3A3A3A]" : "border-[#E8E8E8]"
                          }`}
                        />
                        <div
                          className={`w-16 h-16 rounded-full border-4 border-b-primary-red animate-spin ${
                            isDark ? "border-[#3A3A3A]" : "border-[#E8E8E8]"
                          }`}
                          style={{
                      ...
                      >
                        <EditableText
                          path="services.hero.visualLabel"
                          fallback="Full-Stack Engineering"
                          as="span"
                        />
                      </span>
                    </div>
