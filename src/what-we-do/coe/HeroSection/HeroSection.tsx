...
export default function HeroSection() {
  return (
    <SectionThemeWrapper sectionId="coe_hero" defaultTheme="dark">
      {(theme) => {
              ...
              <div className="lg:grid lg:grid-cols-12 lg:gap-8 items-center">
                ...
                >
                  ...
                  <motion.h1 variants={fadeUp} className="mb-6 leading-none">
                    <EditableText
                      path="coe.hero.heading"
                      fallback="Driving Innovation Through Centers of Excellence"
                      as="span"
                  ...
                  >
                    ...
                    >
                      <EditableText
                        path="coe.hero.ctaPrimary"
                        fallback="Explore CoEs"
                        as="span"
                      />
                    </a>
                    <a
                    ...
                    >
                      <EditableText
                        path="coe.hero.ctaSecondary"
                        fallback="View Research"
                        as="span"
                      />
                    </a>
                  </motion.div>
                ...
                >
                  ...
                  >
                    ...
                    <div className="relative z-10 flex flex-col items-center gap-3">
                      ...
                      >
                        <EditableText
                          path="coe.hero.visualLabel"
                          fallback="Innovation Ecosystem"
                          as="span"
                        />
                      </span>
                    </div>
