...
export default function HeroSection() {
  return (
    <SectionThemeWrapper sectionId="alliance_hero" defaultTheme="dark">
      {(theme) => {
            ...
            <Container className="relative z-10 w-full">
              <div className="lg:grid lg:grid-cols-12 lg:gap-8 items-center">
                ...
                >
                  ...
                  >
                    {/* <EditableText
                      path="alliance.hero.badge"
                      fallback="Strategic Alliances"
                      as="span"
                  ...
                  <motion.h1 variants={fadeUp} className="mb-6 leading-none">
                    <EditableText
                      path="alliance.hero.heading"
                      fallback="Powering Innovation Through Strategic Partnerships"
                      as="span"
                  ...
                  >
                    ...
                    >
                      <EditableText
                        path="alliance.hero.ctaPrimary"
                        fallback="View Our Partners"
                        as="span"
                      />
                    </a>
                    <a
                    ...
                    >
                      <EditableText
                        path="alliance.hero.ctaSecondary"
                        fallback="Become a Partner"
                        as="span"
                      />
                    </a>
                  </motion.div>
                ...
                >
                  ...
                  >
                    ...
                    <div className="relative z-10 flex flex-col items-center gap-3">
                      ...
                      >
                        <EditableText
                          path="alliance.hero.visualLabel"
                          fallback="Ecosystem of Trust"
                          as="span"
                        />
                      </span>
                    </div>
