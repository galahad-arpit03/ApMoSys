...
export default function HeroSection() {
  ...
  return (
    <section ref={ref} className="relative pt-24 pb-16 lg:pt-32 lg:pb-24 overflow-hidden flex items-center min-h-[50vh]">
      ...
      >
        <EditableImage label="Industries Hero Background" className="relative w-full h-full">
          <Image
            src="/assets/images/domains/industries.png"
      ...
      <div className="max-w-[1600px] mx-auto px-6 sm:px-8 lg:px-16 relative z-10 w-full">
        <div className="max-w-3xl">
          ...
          >
            ...
            >
              <EditableText
                path="industries.hero.heading1"
                fallback="Engineering Precision"
                as="span"
              />{' '}
              <EditableText
                path="industries.hero.heading2"
                fallback="Across Every Sector"
                as="span"
            ...
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-4">
              ...
              >
                <EditableText path="industries.hero.ctaPrimary" fallback="View Solutions" as="span" />
                <svg
              ...
              >
                <EditableText path="industries.hero.ctaSecondary" fallback="Contact Expert" as="span" />
