          ...
          {benefitItems.map((benefit, idx) => {
            ...
            return (
              <motion.div
                ...
                className={`group flex items-start gap-4 p-5 xl:p-8 hover:bg-white/[0.02] transition-all duration-300 cursor-pointer ${getBorderClasses(
                  idx,
                  benefitItems.length
                )}`}
              >
                ...
                <div className="flex-grow min-w-0">
                  <h3 className="text-base xl:text-lg font-medium text-white mb-1 leading-tight group-hover:text-[#2563EB] transition-colors duration-300">
                    <EditableText
