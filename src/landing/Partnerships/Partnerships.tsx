        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-4 lg:sticky lg:top-24">
            <h2 className="text-3xl md:text-5xl font-black text-gray-900 mb-6 tracking-tight leading-tight">
              Strategic <br/> <span className="text-[#B40001]">Partnerships.</span>
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {partners.map((partner, idx) => (
                <motion.div
                  ...
                  className="bg-gray-50 border border-gray-100 p-8 rounded-md hover:border-[#B40001]/30 hover:shadow-lg transition-all duration-300 group flex items-center gap-6"
                >
                  <div className="w-16 h-16 rounded-md bg-white border border-gray-200 flex items-center justify-center text-3xl shadow-sm group-hover:border-[#B40001]/20 transition-colors">
                    {partner.icon}
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 group-hover:text-[#B40001] transition-colors">
                      {partner.name}
                    </h3>
