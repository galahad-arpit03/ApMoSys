    ...
    <section className="py-16 pb-24 border-b border-[#E8E8E8]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <EditableText
          ...
          as="h2"
          className="font-heading text-3xl font-extrabold text-[#121212] mb-16 block"
        />
            ...
            {items.map((item, idx) => (
              ...
              >
                <EditableText
                  ...
                  fallback={item.title}
                  as="h3"
                  className="font-heading text-xl font-bold text-[#121212] mb-3 block"
                />
                <EditableText
                  path={`industries.complexItems.${idx}.description`}
                  fallback={item.description}
                  as="p"
                  className="text-[#4A4A4A] leading-relaxed block"
                  multiline
                />
                ...
                {isEditRoute && (
                  <button
                    ...
                    className="absolute right-0 top-0 text-red-500 hover:text-red-700 bg-red-50 hover:bg-red-100 p-1.5 rounded-full opacity-0 group-hover/card:opacity-100 transition-opacity duration-200 z-30 cursor-pointer"
                    title="Delete item"
                  >
        ...
        {isEditRoute && (
          <div className="mt-12 flex justify-center">
            <button
              ...
              className="flex items-center gap-2 border-2 border-dashed border-[#E8E8E8] hover:border-primary-red/50 px-8 py-3 rounded-xl text-sm font-bold text-[#121212] hover:text-primary-red transition-all cursor-pointer group"
            >
