    ...
    return (
      <li className="flex flex-col">
        ...
        >
          ...
          <svg className={`w-3 h-3 text-white group-hover:text-primary-red transition-transform ${isExpanded ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <AnimatePresence initial={false}>
          {isExpanded && (
            <motion.ul
              ...
              className="pl-3 mt-2 space-y-2 border-l border-[#3A3A3A] text-white overflow-hidden"
            >
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-8 h-8 rounded-full bg-[#1F1F1F] flex items-center justify-center text-white hover:bg-primary-red hover:text-[#FFFFFF] transition-colors">
        ...
        <div className="border-t border-[#1F1F1F] pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
          ...
          <div className="flex flex-wrap justify-center sm:justify-end gap-4 sm:gap-6 text-xs text-white">
