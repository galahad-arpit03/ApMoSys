...
export default function TechnicalLibrary() {
  return (
    <section className="bg-[#FAFAFA] text-[#121212] py-24 border-t border-[#E8E8E8]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {resources.map((res, idx) => (
            ...
            >
              ...
              <span className="text-[#A0A0A0] text-[10px] font-bold uppercase tracking-widest mb-4 block">
                {res.tag}
              </span>
              
              <h3 className="font-heading font-bold text-lg text-[#121212] mb-3 pr-8 leading-snug">
                {res.title}
              </h3>
