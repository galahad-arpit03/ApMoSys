      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <div className="flex items-center justify-center mt-8 bg-[#1F1F1F] border border-[#3A3A3A] p-1 rounded-md max-w-md mx-auto">
            <button
              ...
              className={`flex-1 py-2 text-xs font-bold rounded transition-colors ${selectedTab === "services" ? "bg-primary-red text-[#FFFFFF]" : "text-[#A0A0A0] hover:text-[#FAFAFA]"}`}
            >
              Services
            </button>
            <button
              onClick={() => setSelectedTab("solutions")}
              className={`flex-1 py-2 text-xs font-bold rounded transition-colors ${selectedTab === "solutions" ? "bg-primary-red text-[#FFFFFF]" : "text-[#A0A0A0] hover:text-[#FAFAFA]"}`}
            >
              Solutions
            </button>
            <button
              onClick={() => setSelectedTab("industries")}
              className={`flex-1 py-2 text-xs font-bold rounded transition-colors ${selectedTab === "industries" ? "bg-primary-red text-[#FFFFFF]" : "text-[#A0A0A0] hover:text-[#FAFAFA]"}`}
            >
              Industries
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {selectedTab === "services" && (
            <>
              <div className="bg-[#1F1F1F] border border-[#3A3A3A] p-8 rounded-lg">
                <div className="w-12 h-12 bg-primary-red/10 border border-primary-red/30 text-primary-red rounded flex items-center justify-center mb-6 font-bold text-lg">01</div>
              ...
              <div className="bg-[#1F1F1F] border border-[#3A3A3A] p-8 rounded-lg">
                <div className="w-12 h-12 bg-primary-red/10 border border-primary-red/30 text-primary-red rounded flex items-center justify-center mb-6 font-bold text-lg">02</div>
              ...
              <div className="bg-[#1F1F1F] border border-[#3A3A3A] p-8 rounded-lg">
                <div className="w-12 h-12 bg-primary-red/10 border border-primary-red/30 text-primary-red rounded flex items-center justify-center mb-6 font-bold text-lg">03</div>
          ...
          {selectedTab === "solutions" && (
            <>
              <div className="bg-[#1F1F1F] border border-[#3A3A3A] p-8 rounded-lg">
                <div className="w-12 h-12 bg-primary-red/10 border border-primary-red/30 text-primary-red rounded flex items-center justify-center mb-6 font-bold text-lg">QA</div>
              ...
              <div className="bg-[#1F1F1F] border border-[#3A3A3A] p-8 rounded-lg">
                <div className="w-12 h-12 bg-primary-red/10 border border-primary-red/30 text-primary-red rounded flex items-center justify-center mb-6 font-bold text-lg">AI</div>
              ...
              <div className="bg-[#1F1F1F] border border-[#3A3A3A] p-8 rounded-lg">
                <div className="w-12 h-12 bg-primary-red/10 border border-primary-red/30 text-primary-red rounded flex items-center justify-center mb-6 font-bold text-lg">OPS</div>
          ...
          {selectedTab === "industries" && (
            <>
              <div className="bg-[#1F1F1F] border border-[#3A3A3A] p-8 rounded-lg">
                <div className="w-12 h-12 bg-primary-red/10 border border-primary-red/30 text-primary-red rounded flex items-center justify-center mb-6 font-bold text-lg">BK</div>
              ...
              <div className="bg-[#1F1F1F] border border-[#3A3A3A] p-8 rounded-lg">
                <div className="w-12 h-12 bg-primary-red/10 border border-primary-red/30 text-primary-red rounded flex items-center justify-center mb-6 font-bold text-lg">EC</div>
              ...
              <div className="bg-[#1F1F1F] border border-[#3A3A3A] p-8 rounded-lg">
                <div className="w-12 h-12 bg-primary-red/10 border border-primary-red/30 text-primary-red rounded flex items-center justify-center mb-6 font-bold text-lg">HC</div>
