            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                <EditableText
                  ...
                  as="h2"
                  className={`font-heading text-3xl sm:text-4xl font-extrabold mb-4 block text-center ${
                ...
                <EditableText
                  ...
                  as="p"
                  className={`text-sm sm:text-base block text-center ${
                ...
                {isAdmin && (
                  <button
                    ...
                    className={`mt-6 font-bold text-xs uppercase tracking-wider px-5 py-2.5 rounded-md inline-flex items-center gap-2 shadow-md transition-all cursor-pointer ${
                      isDark ? "bg-[#FFFFFF] hover:bg-primary-red text-[#121212] hover:text-[#FFFFFF]" : "bg-[#121212] hover:bg-primary-red text-[#FFFFFF]"
                    }`}
                  >
                ...
                <AnimatePresence mode="wait">
                  {faqItems.map((faq, idx) => (
                    <motion.div
                      ...
                      className={`border rounded-xl overflow-hidden relative border ${
                    ...
                    >
                      <div className="flex items-center justify-between w-full pr-4">
                        <button
                          ...
                          className={`flex-1 flex items-center justify-between px-6 py-5 text-left transition-colors cursor-pointer ${
                            isDark ? "bg-[#1A1A1A] hover:bg-[#242424]" : "bg-[#FFFFFF] hover:bg-[#F5F5F5]"
                          }`}
                        >
                          <EditableText
                            ...
                            as="span"
                            className={`font-semibold text-sm sm:text-base pr-6 block ${isDark ? "text-[#FFFFFF]" : "text-[#121212]"}`}
                          />
                      ...
                      <AnimatePresence initial={false}>
                        {openIndex === idx && (
                          ...
                          >
                            <div className={`px-6 py-5 border-t ${isDark ? "border-[#2A2A2A]" : "border-[#E8E8E8]"}`}>
                              <EditableText
